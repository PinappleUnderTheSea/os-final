/****************************************************************************
** Meta object code from reading C++ file 'defappplugin.h'
**
...
#include <memory>
#include "../../../src/plugin-defaultapp/window/defappplugin.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/qplugin.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'defappplugin.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject SelfStartupModule::staticMetaObject = { {
    QMetaObject::SuperData::link<dccV23::VListModule::staticMetaObject>(),
...
void *SelfStartupModule::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelfStartupModule.stringdata0))
        return static_cast<void*>(this);
    return dccV23::VListModule::qt_metacast(_clname);
}

int SelfStartupModule::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = dccV23::VListModule::qt_metacall(_c, _id, _a);
    return _id;
}
